...
let challengeProjectedPopulations = precinctPopulations.map { $0 * 2 }
challengeProjectedPopulations

let challengeBigProjections = projectedPopulations.filter{ $0 > 4000 }
challengeBigProjections

let challengeTotalProjection = projectedPopulations.reduce(0, +)
challengeTotalProjection
